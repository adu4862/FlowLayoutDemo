package com.yl.flowlayoutdemo.ui;
...
public class FlowLayout extends ViewGroup{
	...
	/**
	 * 设置textview监听,这里用来自定义每个Textview
	 * @param mTextViewListener
     */
	public void setmTextViewListener(TextViewListener mTextViewListener) {
	 ...
	 * @param arr String数组
	 */
	public void setDataToFlowLayout(String[]arr) {
		for (int i = 0; i < arr.length; i++) {
			 TextView textView = new TextView(getContext());
			textView.setText(arr[i]);
			this.addView(textView);
			mTextViewListener.settextView(textView);
		}
	}
	 ...
	 * @param list String集合
     */
	public void setDataToFlowLayout(ArrayList<String> list) {
	...
	/**
	 * 设置flowLayout的padding和条目之间的距离
	 * @param padding
	 * @param horizontalSpacing 条目之间的水平间距
	 * @param verticalSpacing 条目之间的竖直间距
     */
	public void setPaddingAndSpacing( int padding, int horizontalSpacing,int verticalSpacing) {
		//设置padding
